...
export class StaticSite extends Construct {
  constructor(scope: Construct, id: string, { domainName, siteSubDomain }: StaticSiteProps) {
    ...
    const certificate = acm.Certificate.fromCertificateArn(this, 'cert', 'arn:aws:acm:us-east-1:670799836323:certificate/28826456-e703-4658-9de4-006846add9ef');
    ...
    cdn.addBehavior('*.html', origin, {
      ...
      responseHeadersPolicy: new cloudfront.ResponseHeadersPolicy(this, 'HTMLCacheControl', {
        customHeadersBehavior: {
          customHeaders: [
            {
              header: 'Cache-Control',
